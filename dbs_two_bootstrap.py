...
def GLM_two(XS,n=2000):
	...
	plt.savefig('Trace_Bootstrap.png')
...
def plot_two(X, One, Two, intercept):
	...
	plt.title('Classification by Two Bootstrap Samples', fontsize=16)
	plt.tight_layout()
	plt.savefig('PD_Bootstrap.png')
	#plt.show()
	plt.traceplot(trace)
	...
	cm.to_csv('Confusion Matrix Bootstrap', index=False)
	return ps, pps, cm
